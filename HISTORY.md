...
- 벽짚기 제작
- v0.0.2:150
- 벽짚고 방향키 안누르면 떨어지도록 설정
- v0.0.2:151
- 점프 상태에서 방향키 움직이도록 변경
- v0.0.2:152
- 게임은 모바일 지원 안하는것으로.
- v0.0.2:153
...
- phaserJS 이미지 로드 오류 해결 -> 직접 url입력
- 벽에서 점프 시 0.1초동안 방향키 무효화.
- idle상태에서 점프 시 walk속도로 방향전환 가능하도록 변경
- v0.0.2:154
- 데모 게임 타이틀 완성
- v0.0.2:155

### 2023 7/5
- phaserJS build하면 이미지 안올라가는 버그 개선
- v0.0.3:156
- aws cli 연결
- v0.0.3:157